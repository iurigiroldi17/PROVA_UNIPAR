...
public class CadastroAvaliacaoDeAlimentos {
    public static void main(String[] args) {
        ...
        // Criar um vetor para armazenar as avaliações
        ...
        for (int i = 0; i < numAlimentos; i++) {
            double nota;
            while (true) {
                System.out.printf("Digite a avaliação para o alimento  (entre 0 e 10): ", i + 1);
        ...
        // Exibe a média
        System.out.printf("A média das avaliações é: ", media);
